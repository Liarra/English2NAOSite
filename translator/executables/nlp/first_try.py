...
from translator.executables.nlp.component import button_press, unrecognised_component
from translator.executables.nlp.execution import sequence, parallel
